...
- **Advanced Filtering**: Filter by CSM, risk type, expiry window, and account name
- **Data Fabric Integration**: Structured for seamless UiPath Data Fabric entity integration
...
- **UiPath TypeScript SDK** for Data Fabric integration (future)
...
- UiPath Cloud account (for OAuth authentication)
...
The application uses a static JSON dataset (`src/data/accounts.json`) structured to match UiPath Data Fabric entity schema:
...
- `VITE_UIPATH_SCOPE`: Required OAuth scopes
...
- **Data Fabric Integration**: Replace static JSON with live UiPath Data Fabric entity queries
